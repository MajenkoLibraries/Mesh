...
class nRF24L01 : public L2 {
    ...
    public:
        ...
        // L2 standard interface functions
        int getHardwareAddress(uint8_t *buffer);
        void unicastPacket(uint8_t *addr, uint8_t *data);
        void broadcastPacket(uint8_t *data);
